...
def main() -> None:
    ...
    try:
        while True:
            ...
            cmd = f"!{v:.2f}@{w:.2f}#"
            FLASK_URL = 'http://<FLASK_SERVER_IP>:5000/ml'
              
            # inside your main loop, after computing v,w and cmd:
            try:
              requests.post(FLASK_URL, json={'v':v,'w':w}, timeout=0.1)
            except Exception as e:
              print("ML→Flask error:", e)
